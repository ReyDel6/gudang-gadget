            ...
            <div class="flex-1 flex items-center justify-center bg-navy-50 px-6 py-12">
                <div class="w-full max-w-sm">
                    ...
                    <form method="POST" action="<?php echo e(route('password.email')); ?>">
                        <div class="bg-white rounded-2xl border border-navy-100 p-6 space-y-5 shadow-sm">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" required value="<?php echo e(old('email')); ?>" autofocus
                    ...
                    <p class="text-sm text-navy-500 text-center mt-6">
                        Ingat sandi?
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gold-600 hover:text-gold-500">Kembali ke login</a>
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH D:\WEB\web gudang\registrasi-siswa\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>