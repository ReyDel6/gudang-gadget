        ...
        <div class="flex min-h-screen">
            ...
            <div class="flex-1 flex items-center justify-center bg-navy-50 px-6 py-12">
                <div class="w-full max-w-sm">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="lg:hidden flex items-center justify-center gap-2 mb-8">
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>" class="bg-white rounded-2xl border border-navy-100 p-6 space-y-5 shadow-sm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" required value="<?php echo e(old('name')); ?>" autofocus autocomplete="name"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" required value="<?php echo e(old('email')); ?>" autocomplete="email"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <p class="text-sm text-navy-500 text-center mt-6">
                        Sudah punya akun?
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-gold-600 hover:text-gold-500">Masuk</a>
                    </p>
                </div>
            </div>
            ...
            <div class="hidden lg:flex w-1/2 relative overflow-hidden bg-navy-800 text-white flex-col justify-between p-12">
                ...
                <div class="relative flex items-center justify-end">
                    <a href="<?php echo e(route('login')); ?>" class="flex items-center gap-2">
...
</html><?php /**PATH D:\WEB\web gudang\registrasi-siswa\resources\views/auth/register.blade.php ENDPATH**/ ?>